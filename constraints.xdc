...
set_property PACKAGE_PIN V3 [get_ports {leds[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[8]}]
set_property PACKAGE_PIN W3 [get_ports {leds[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[9]}]
set_property PACKAGE_PIN U3 [get_ports {leds[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[10]}]
set_property PACKAGE_PIN P3 [get_ports {leds[11]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[11]}]
set_property PACKAGE_PIN N3 [get_ports {leds[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[12]}]
set_property PACKAGE_PIN P1 [get_ports {leds[13]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds[13]}]
set_property PACKAGE_PIN L1 [get_ports {leds[14]}]					
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports note]					
	set_property IOSTANDARD LVCMOS33 [get_ports note]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports volume]					
	set_property IOSTANDARD LVCMOS33 [get_ports volume]
##Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {JB[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {JB[2]}]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports lowpower]					
	set_property IOSTANDARD LVCMOS33 [get_ports lowpower]
##Sch name = JB7
